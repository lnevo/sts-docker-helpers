...
| `recolor_car_reports.php` | — (`php recolor_car_reports.php [N|all]`: patch Action/Destination cells with `locations.color` swatches on cached station/wheel report HTML) |
